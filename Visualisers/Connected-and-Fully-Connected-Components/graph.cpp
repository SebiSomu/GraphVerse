    ...
    if(m_nodes.size() + 1 >= m_nodes.capacity()) {
        ...
        for(const auto& ed : tempEdges) {
            ...
            for(auto& node : m_nodes) {
                if(node.getIndex() == ed.getFirst().getIndex()) {
                    first = &node;
                }
                if(node.getIndex() == ed.getSecond().getIndex()) {
                    second = &node;
                }
            }

            if(first && second) {
                m_edges.emplace_back(first, second);
            }
        }
    }
    else {
...
int Graph::getComponentColor(int nodeIndex) const {
    if(nodeIndex < 1 || nodeIndex > (int)m_componentsColors.size()) {
        return -1;
    }
    return m_componentsColors[nodeIndex - 1];
}

int Graph::getNumComponents() const {
...
QColor Graph::getColorForComponent(int component) const {
    ...
    if (component < baseColorsSize) {
        return baseColors[component];
    }
    ...
    case 0:
        return QColor(
            120 + static_cast<int>(135 * progression),
            20 + static_cast<int>(180 * progression),
            20 + static_cast<int>(180 * progression)
            );

    case 1:
        return QColor(
            180 + static_cast<int>(60 * progression),
            180 + static_cast<int>(60 * progression),
            50 + static_cast<int>(50 * progression)
            );

    case 2:
        return QColor(
            30 + static_cast<int>(40 * progression),
            80 + static_cast<int>(100 * progression),
            150 + static_cast<int>(80 * progression)
            );

    case 3:
        return QColor(
            100 + static_cast<int>(80 * progression),
            30 + static_cast<int>(40 * progression),
            120 + static_cast<int>(80 * progression)
            );

    case 4:
        return QColor(
            30 + static_cast<int>(40 * progression),
            120 + static_cast<int>(100 * progression),
            80 + static_cast<int>(80 * progression)
            );
    ...
    case 8:
        return QColor(
            160 + static_cast<int>(60 * progression),
            140 + static_cast<int>(60 * progression),
            100 + static_cast<int>(60 * progression)
            );
    ...
    case 9:
        return QColor(
            0,
            100 + static_cast<int>(80 * progression),
            140 + static_cast<int>(80 * progression)
            );
    ...
    case 11:
        return QColor(
            120 + static_cast<int>(60 * progression),
            80 + static_cast<int>(60 * progression),
            140 + static_cast<int>(60 * progression)
            );
