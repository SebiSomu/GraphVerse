#include "theoretical_page_builder.h"
#include "../GraphVersePlatform.h"  // For AnimatedButton
#include <QVBoxLayout>
#include <QScrollArea>

TheoreticalPageBuilder::TheoreticalPageBuilder(
...
QWidget* TheoreticalPageBuilder::build() {
    ...
    vlay->addWidget(m_headerBuilder("Theoretical Applications", "📚", m_accentColor));
