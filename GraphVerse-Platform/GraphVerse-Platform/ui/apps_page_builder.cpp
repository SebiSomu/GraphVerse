#include "apps_page_builder.h"
#include "../GraphVersePlatform.h"  // For AnimatedButton
#include <QVBoxLayout>
#include <QScrollArea>

AppsPageBuilder::AppsPageBuilder(
...
QWidget* AppsPageBuilder::build() {
    ...
    vlay->addWidget(m_headerBuilder("Real-World Applications", "🌐", m_accentColor));
